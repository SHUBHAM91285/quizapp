...
class Quiz(models.Model):
    ...
    def import_quiz_from_excel(self):
        ...
        for index, row in df.iterrows():
            ...
            choice_1 = Choice.objects.get_or_create(question=question[0],text = choice1,is_correct = correct_ans == 'A')
            choice_2 = Choice.objects.get_or_create(question=question[0],text = choice2,is_correct = correct_ans == 'B')
            choice_3 = Choice.objects.get_or_create(question=question[0],text = choice3,is_correct = correct_ans == 'C')
            choice_4 = Choice.objects.get_or_create(question=question[0],text = choice4,is_correct = correct_ans == 'D')
...
def update_leaderboard():
    #take all user and calculate the sum of scores of every user
